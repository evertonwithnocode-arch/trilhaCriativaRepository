...
export default function Assinaturas() {
  ...
  const handleSubscribe = async (plan: "pro" | "time") => {
    ...
    await supabase
  .from("usuarios")
  .update({ plano: `plano ${plan} (teste)` })
  .eq("id", user.id);

setUserData((prev) => prev ? { ...prev, plano: `plano ${plan} (teste)` } : prev);
navigate("/dashboard");

      toast.success(`Plano ${plan.toUpperCase()} (teste) ativado com sucesso!`);
      navigate("/dashboard");
// ✅ agora funciona
    } catch (err: any) {
      ...
      <div className="px-4 lg:px-8 pb-20">
        ...
        <div className="flex justify-center mb-16 gap-4">
          <button
            ...
            className={`flex h-10 justify-center items-center gap-4 px-5 py-2 rounded-xl transition-all ${
          ...
          <button
            ...
            className={`flex h-10 justify-center items-center gap-2 px-5 py-2 rounded-xl transition-all ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 px-4 lg:px-16">
            ...
            {/* Pro Plan */}
            <div className="bg-white shadow-[0_3px_0_0_#FFE0B2] relative p-10 rounded-3xl border-2 border-solid border-[#FBDEB1]">
              <div className="mb-6">
                <h2 className="font-baloo text-[32px] font-[800] leading-[32px] text-dark-gray mb-2">
                  Pro
                </h2>
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="font-baloo text-[64px] font-[800] leading-[64px] text-dark-gray">
                  R$ 59,90
                </div>
                <div className="font-nunito text-[16px] font-[500] text-dark-gray leading-[20px] text-right">
                  por mês<br />pago anualmente
                </div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-[#F7B34D] text-white font-nunito text-[18px] font-[800] py-3 px-6 rounded-xl mb-8 hover:bg-orange/90 transition-colors disabled:opacity-50"
              >
                {loading ? "Ativando..." : "Testar por 7 dias"}
              </button>
              ...
              <div className="space-y-4">
                {[
                  ...
                  "Acesso completo à biblioteca de jogos",
                  ...
                  <div key={index} className="flex items-center gap-2">
                    <ChevronRightIcon />
                    <span className="font-nunito text-[16px] text-dark-gray leading-[20px]">
                      {feature}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-white shadow-[0_3px_0_0_#FFE0B2] relative p-10 rounded-3xl border-2 border-solid border-[#FBDEB1]">
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="font-nunito text-[16px] font-[500] text-dark-gray leading-[20px] text-right">
                  por membro / mês<br />pago anualmente
                </div>
              </div>
